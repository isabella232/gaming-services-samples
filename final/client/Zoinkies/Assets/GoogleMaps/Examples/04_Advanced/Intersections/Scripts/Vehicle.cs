...
namespace Google.Maps.Examples {
  ...
  public class Vehicle : MonoBehaviour {
    ...
    /// </summary>
    private Vector2Int CurrentNodeLocation;

    /// <summary>
    /// The location of the target node for this vehicle to path to.
    /// </summary>
    private Vector2Int TargetNodeLocation;
    ...
    public void Initialize(TrafficSystem trafficSystem, RoadLatticeNode startNode) {
      ...
      CurrentNodeLocation = startNode.IntLocation;
      TargetNodeLocation = targetNode.IntLocation;
    ...
    void Update() {
      ...
      if (Ticket.DistanceToTarget < MaxDistanceUntilNextTarget) {
        ...
        TrafficSystem.PathTicket nextTicket =
            TrafficSystem.Request(TargetNodeLocation, nextTargetNode.IntLocation, this);
        if (nextTicket == null) {
        ...
        TargetNodeLocation = nextTargetNode.IntLocation;
      }
    }
